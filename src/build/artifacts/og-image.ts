...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <text x="600" y="290" font-size="72" font-weight="700" text-anchor="middle" fill="#f8f7f5" font-family="system-ui, sans-serif" letter-spacing="-0.02em">${escapeXml(SITE_TITLE)}</text>
  <text x="600" y="370" font-size="28" text-anchor="middle" fill="#8a8880" font-family="system-ui, sans-serif">${escapeXml(SITE_DOMAIN)}</text>
</svg>`;
